...
macro_rules! layout_qualifier {
    (location = $value:literal) => {
        ::gpu_bulwark::glsl::variable::layout::Location<$value>
    };
}
...
macro_rules! storage_qualifier {
    (in) => {
        ::gpu_bulwark::glsl::variable::storage::In
    };
    (out) => {
        ::gpu_bulwark::glsl::variable::storage::Out
    };
    (uniform) => {
        ::gpu_bulwark::glsl::variable::storage::Uniform
    };
}

#[macro_export]
macro_rules! type_qualifier {
    (vec2  ) => { ::gpu_bulwark::glsl::Vec2   };
    (vec3  ) => { ::gpu_bulwark::glsl::Vec3   };
    (vec4  ) => { ::gpu_bulwark::glsl::Vec4   };
    (ivec2 ) => { ::gpu_bulwark::glsl::IVec2  };
    (ivec3 ) => { ::gpu_bulwark::glsl::IVec3  };
    (ivec4 ) => { ::gpu_bulwark::glsl::IVec4  };
    (uvec2 ) => { ::gpu_bulwark::glsl::UVec2  };
    (uvec3 ) => { ::gpu_bulwark::glsl::UVec3  };
    (uvec4 ) => { ::gpu_bulwark::glsl::UVec4  };
    (dvec2 ) => { ::gpu_bulwark::glsl::DVec2  };
    (dvec3 ) => { ::gpu_bulwark::glsl::DVec3  };
    (dvec4 ) => { ::gpu_bulwark::glsl::DVec4  };
    (mat2  ) => { ::gpu_bulwark::glsl::Mat2   };
    (mat2x2) => { ::gpu_bulwark::glsl::Mat2x2 };
    (mat2x3) => { ::gpu_bulwark::glsl::Mat2x3 };
    (mat2x4) => { ::gpu_bulwark::glsl::Mat2x4 };
    (mat3  ) => { ::gpu_bulwark::glsl::Mat3   };
    (mat3x2) => { ::gpu_bulwark::glsl::Mat3x2 };
    (mat3x3) => { ::gpu_bulwark::glsl::Mat3x3 };
    (mat3x4) => { ::gpu_bulwark::glsl::Mat3x4 };
    (mat4  ) => { ::gpu_bulwark::glsl::Mat4   };
    (mat4x2) => { ::gpu_bulwark::glsl::Mat4x2 };
    (mat4x3) => { ::gpu_bulwark::glsl::Mat4x3 };
    (mat4x4) => { ::gpu_bulwark::glsl::Mat4x4 };
    (vec2   $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(vec2   $([$sizes])*), $size>  };
    (vec3   $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(vec3   $([$sizes])*), $size>  };
    (vec4   $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(vec4   $([$sizes])*), $size>  };
    (ivec2  $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(ivec2  $([$sizes])*), $size>  };
    (ivec3  $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(ivec3  $([$sizes])*), $size>  };
    (ivec4  $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(ivec4  $([$sizes])*), $size>  };
    (uvec2  $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(uvec2  $([$sizes])*), $size>  };
    (uvec3  $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(uvec3  $([$sizes])*), $size>  };
    (uvec4  $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(uvec4  $([$sizes])*), $size>  };
    (dvec2  $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(dvec2  $([$sizes])*), $size>  };
    (dvec3  $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(dvec3  $([$sizes])*), $size>  };
    (dvec4  $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(dvec4  $([$sizes])*), $size>  };
    (mat2   $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(mat2   $([$sizes])*), $size>  };
    (mat2x2 $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(mat2x2 $([$sizes])*), $size>  };
    (mat2x3 $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(mat2x3 $([$sizes])*), $size>  };
    (mat2x4 $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(mat2x4 $([$sizes])*), $size>  };
    (mat3   $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(mat3   $([$sizes])*), $size>  };
    (mat3x2 $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(mat3x2 $([$sizes])*), $size>  };
    (mat3x3 $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(mat3x3 $([$sizes])*), $size>  };
    (mat3x4 $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(mat3x4 $([$sizes])*), $size>  };
    (mat4   $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(mat4   $([$sizes])*), $size>  };
    (mat4x2 $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(mat4x2 $([$sizes])*), $size>  };
    (mat4x3 $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(mat4x3 $([$sizes])*), $size>  };
    (mat4x4 $([$sizes:literal])* [$size:literal]) => { ::gpu_bulwark::glsl::Array<type_qualifier!(mat4x4 $([$sizes])*), $size>  };
}

#[macro_export]
macro_rules! Glsl {
    (layout($qualifier:ident = $value:literal) $storage:ident $type:ident $([$size:literal])*;) => {
        ((), ::gpu_bulwark::glsl::variable::Variable::<
            ::gpu_bulwark::storage_qualifier!($storage),
            ::gpu_bulwark::layout_qualifier!($qualifier = $value),
            ::gpu_bulwark::type_qualifier!($type $([$size])*)
        >
    )
    };
    ...
    (@ $acc:ty => layout($qualifier:ident = $value:literal) $storage:ident $type:ident $([$size:literal])*) => {
        ($acc, ::gpu_bulwark::glsl::variable::Variable::<
            ::gpu_bulwark::storage_qualifier!($storage),
            ::gpu_bulwark::layout_qualifier!($qualifier = $value),
            ::gpu_bulwark::type_qualifier!($type $([$size])*)
        >)
...
macro_rules! glsl {
    (layout($qualifier:ident = $value:literal) $storage:ident $type:ident $([$size:literal])*;) => {
        ::gpu_bulwark::constraint::ValidExt::validated(
            ((), ::gpu_bulwark::glsl::variable::Variable::<
                ::gpu_bulwark::storage_qualifier!($storage),
                ::gpu_bulwark::layout_qualifier!($qualifier = $value),
                ::gpu_bulwark::type_qualifier!($type $([$size])*)
...
macro_rules! vars {
    ...
    ($ident: ident, $($idents: tt),* $(,)?) => {
        ::gpu_bulwark::glsl::variable::vars!(@ ((), $ident), $($idents),*)
    };
    (@ $acc: tt, $ident: tt $(,)?) => {
        ($acc, $ident)
    };
    (@ $acc: tt, $ident: ident, $($idents: tt),* $(,)?) => {
        ::gpu_bulwark::glsl::variable::vars!(@ ($acc, $ident), $($idents),*)
    };
}
