...
We then precede to define semantics of our type state. We allow direct creation of only anonymous sessions, as well as access to secrete information
for authenticated users. Now all that remains are the state transitions.
